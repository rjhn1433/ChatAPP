          ...
          {messageRequests.length > 0 && (
            <div className="mt-3 space-y-2 max-h-40 overflow-y-auto">
              {messageRequests.map((user) => (
                <div
                  key={user._id}
                  className="p-2 border rounded flex items-center justify-between bg-base-200"
                >
            ...
            <div className="hidden lg:flex justify-between items-center w-full">
              <div className="min-w-0">
                ...
                >
                  {user.lastMessage ? (
                    <>
                      {user.lastMessage.senderId === user._id
                        ? ""
                        : "You: "}
              ...
              {user.unreadCount > 0 && (
                <span className="ml-3 min-w-[22px] h-5 px-1 flex items-center justify-center rounded-full bg-blue-600 text-white text-[11px] font-bold">
                  {user.unreadCount}
                </span>
              )}
            </div>
